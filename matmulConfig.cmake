...
SET(MATMUL_INDEX_TYPE "size_t" CACHE STRING "The index type.")
...
ENDIF()
OPTION(MATMUL_BUILD_PAR_ALPAKA_ACC_CPU_B_TBB_T_SEQ "Enable the GEMM using the alpaka Thread Building Blocks grid block accelerator back-end on the CPU" OFF)
IF(MATMUL_BUILD_PAR_ALPAKA_ACC_CPU_B_TBB_T_SEQ)
    SET(_MATMUL_BUILD_ALPAKA ON)
    SET(ALPAKA_ACC_CPU_B_TBB_T_SEQ_ENABLE ON CACHE BOOL "" FORCE)
    SET(_MATMUL_BUILD_OMP ON)
    LIST(APPEND _MATMUL_COMPILE_DEFINITIONS_PUBLIC "MATMUL_BUILD_PAR_ALPAKA_ACC_CPU_B_TBB_T_SEQ")
ELSE()
    SET(ALPAKA_ACC_CPU_B_TBB_T_SEQ_ENABLE OFF CACHE BOOL "" FORCE)
ENDIF()
...
IF(NOT MSVC AND NOT CMAKE_CXX_COMPILER_ID STREQUAL "PGI")
