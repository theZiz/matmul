...
function doit {
	rm -rf paper_combination_haswell_icc_$2_$1
	mkdir paper_combination_haswell_icc_$2_$1
	cd paper_combination_haswell_icc_$2_$1
	../make_paper_autotuning_haswell.sh $2
